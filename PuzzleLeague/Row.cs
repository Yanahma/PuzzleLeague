...
//   /// </summary>
//   [Obsolete ("Use 'Board' Data Structure Instead")]
//   class Row
//   {
//      //
//      // Private fields
...
//         else
//         {
//            // position.Y = ScaleHelper.BackBufferHeight - parent.YOffset - (ScaleHelper.ScaleHeight(Block.BlockHeight * parent.IndexOf(this.ToArray())));
...
//      // Same as above, but for block[]
//      static public Block[] RandomRow(GameBoard parent)
//      {
//         Block[] returnArr = new Block[6];
//         Row rndRow = new Row(parent);
//         for (var i = 0; i <= 5; i++)
//         {
//            returnArr[i] = Block.RndBlockExcEmpty(rndRow);
//         }

//         // Correctly assign positions
//         foreach (Block b in returnArr)
//            b.ResetPosition();
